      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-1">
              <a href="?halaman=data_operator" type="button" class="btn btn-warning ">Kembali</a>
            </div>
            ...
            <form action="controller/proses_operator.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_operator" name="nama_operator" placeholder="Nama Operator">
                  </div>
                  <div class="form-group">
