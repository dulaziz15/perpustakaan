...
<body>
    ...
    <div class="text-center mt-4 name">SMK Al-Mahrusiyah </div>
    <form class="p-3 mt-3" action="controller/login.php" method="POST">
        ...
        //     }
        ?>
        <button class="btn mt-3" id="login" name="aksi" value="login">login</button>
    </form>
    <div class="text-center fs-6"> <a href="#">Forget password?</a> or <a href="sign_up.php">Sign up</a> </div>
</div>
</body>
</html>